...
RSpec.describe Pokeedex::Configuration do
  describe "#initialize" do
    ...
    it "returns the default values" do
      expect(subject.playwright_cli_executable_path).to eq(File.join(Dir.pwd, "node_modules", ".bin", "playwright"))
  ...
  describe "#db_name=" do
    ...
    it "returns the db_path" do
      ...
      expect(subject.db_path).to eq(File.join(Pokeedex.root_path, "pokeedex", "db", "pokeedex_test.sqlite3"))
    end
  end
